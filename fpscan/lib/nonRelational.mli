...
module type Domain = sig
  ...
  (** Enable or disable the print of logs for basic operations *)
  val log: bool
  ...
  (* Returns the interval associated to the variable *)
  val to_bounds: t -> Bounds.t

  (* Returns the properties associated to the abstract value,
     like NaN, Pos_infty, etc *)
  val to_properties: t -> Value_properties.t 
