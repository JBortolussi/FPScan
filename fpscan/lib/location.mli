...
(** [incr_loc l] return the same location with the internal counter incremented. *)
val incr_loc : t -> t
...
(** Convert pairs of positions to tiny location type *)
val location_of_positions: Lexing.position -> Lexing.position -> t
