...
#     bitblast_report_dict = report_dicts["bitblast"]
#     fpscan_report_dict = report_dicts["fpscan"]
...
#             ])
#             continue
#         bb_report = bitblast_report_dict[name]
...
#             if bb_report.contains_pitfall(pitfall):
#                 # True positive
#                 abs_TP += 1
#             else:
#                 # False positive
#                 abs_FP += 1
#             abs_tot_fps += 1
#         for pitfall in bb_report.get_absorption():
...
#                 cancel_FP += 1
#             cancel_tot_fps += 1
#         for pitfall in bb_report.get_cancellation():
#             if not fpscan_r.contains_pitfall(pitfall):
#                 # False negative
#                 cancel_FN += 1
#             cancel_tot_bb += 1
...
#         tot_abs_tot_fps += abs_tot_fps
#         tot_abs_tot_bb += abs_tot_bb
#         tot_abs_FP += abs_FP
#         tot_abs_FN += abs_FN
#         tot_abs_TP += abs_TP
#         tot_abs_TN += abs_TN
#         tot_cancel_tot_fps += cancel_tot_fps
#         tot_cancel_tot_bb += cancel_tot_bb
#         tot_cancel_FP += cancel_FP
#         tot_cancel_FN += cancel_FN
#         tot_cancel_TP += cancel_TP
#         tot_cancel_TN += cancel_TN
...
#         latex_dir=os.path.join("tex", "fps_bit_main"),
#         pdf_path="main.pdf"
#     )

#     summary_table.build_pdf(
#         latex_dir=os.path.join("tex", "fps_bit_summary"),
...
def mk_main_table(
    ...
    # main_table.add_top_header("\\textbf{Absorption}", 1, 6)
    # main_table.add_top_header("\\textbf{Cancellation}", 7, 6)
    main_table.add_top_header("\\textbf{Absorption}", 1, 4)
    main_table.add_top_header("\\textbf{Cancellation}", 5, 4)
...
def mk_summary_table(
    ...
    print(f"{n_prgm} program analysed")
    summary_table.add_line([
        "False",
